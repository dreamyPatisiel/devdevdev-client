...
export default function PickContainer({
  ...
  return (
    <div className='rounded-[1.6rem] border-gray2 border-solid border h-[42.3rem]'>
      <div
        className={`bg-gray1 px-[2.4rem] py-[2.8rem] mb-[3.2rem] rounded-t-[1.6rem] h-[10.8rem] ${disabledStyle}`}
      >
        <ArrowWithTitle
