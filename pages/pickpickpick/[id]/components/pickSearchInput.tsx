...
export const PickSearchInput = ({
  ...
  return (
    <div className='w-full flex justify-center'>
      <div
        className={`w-full max-w-[61.6rem] flex flex-row items-center rounded-Radius12 px-[1.2rem] py-[1rem] bg-gray700 text-gray300 p1 focus:outline-none border ${isFocused ? 'border-secondary400' : 'border-gray400'} ${isMobile ? 'mb-[9rem]' : 'mb-[11.4rem]'} ${disabled ? 'opacity-60 pointer-events-none' : ''}`}
      >
        <button
        ...
        <input
          className='bg-gray700 text-white flex-1 focus:outline-none disabled:text-gray300'
