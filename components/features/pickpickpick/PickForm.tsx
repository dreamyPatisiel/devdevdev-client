            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <>
                  <input
                    type='text'
                    className={` border-b-[0.1rem] border-solid border-b-gray2 bg-black py-[1.6rem] placeholder:text-gray4 flex-1 focus:outline-none focus:border-primary400 ${isMobile ? 'st2' : 'h3'}`}
