  ...
  return (
    <div className='pb-[1.6rem]'>
      <div className='flex flex-col py-[1.6rem] gap-[1.6rem]'>
        <div className='w-[17.5rem] h-[2.4rem] rounded-[1.2rem] bg-[#29292E] relative skeleton-item'></div>
        <div className='w-[6.9rem] h-[2.4rem] rounded-[1.2rem] bg-[#29292E] relative skeleton-item'></div>
